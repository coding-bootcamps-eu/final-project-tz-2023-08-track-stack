<template>
  <div>
    ...
    <p v-for="data in store.apiData.djs" :key="data" :data="data">{{ data }}</p>
  </div>
  <div>
    <p>Daten zum testen/ Logged in Dj</p>
    <p v-for="data in store.djLoggedIn" :key="data" :data="data">{{ data }}</p>
  </div>
